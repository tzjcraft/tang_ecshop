...
class alipay
{
    ...
    function get_code($order, $payment)
    {
		...
		$button='';
		//wap端
		if(strripos($_SERVER['REQUEST_URI'],'mobile')>0){
				$button = '<div style="text-align:center"><input type="button" onclick="window.open(\'http://www.99-k.com/aip/alipayapi.php?'.$param. '&sign='.md5($sign).'&sign_type=MD5\')" value="' .$GLOBALS['_LANG']['pay_button']. '" /></div>';
		}else{
			//pc端
